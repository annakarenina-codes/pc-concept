...
const AboutPage: React.FC = () => {
  const teamMembers = [
    { name: 'Cristel Joy Franco', image: '/team/cristel.jpg' },
    { name: 'Anna Karenina Sanglay', image: '/team/anna.jpg' },
    { name: 'Lyn Andrei Seguiguit', image: '/team/lyn.jpg' },
    { name: 'David Borja', image: '/team/david.jpg' },
    { name: 'Juster Mariano', image: '/team/juster.jpg' },
  ];
